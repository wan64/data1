    ...
    if indicator == "适当性等级":
        ...
        if df is None or len(df) == 0:
            ...
            with right_col:
                ...
                ax.legend(title="适当性等级", fontsize=7, loc="upper left", prop=FONT_PROP)
                ...
                ax2.legend(title="适当性等级", fontsize=8, prop=FONT_PROP)
            ...
            if df_org is None or len(df_org) == 0:
                ...
                ax.legend(title="适当性等级", fontsize=9, prop=FONT_PROP)
                ax.spines["top"].set_visible(False)
                ax.spines["right"].set_visible(False)
                plt.tight_layout()
