# -*- coding: utf-8 -*-
"""
整合版 中信建投期货 双合一数据看板【稳定运行定稿版｜字体修复：阿里巴巴普惠体】
优化清单：
...
5.【重点修复】Matplotlib全局字体切换 AlibabaPuHuiTi-3-55-Regular，解决云端中文方框/问号乱码
...
if os.path.exists(FONT_PATH):
    ...
    # 全局rc配置优先普惠体
    matplotlib.rcParams["font.sans-serif"] = [font_name, "PingFang SC", "Arial Unicode MS", "Microsoft YaHei", "SimHei"]
else:
    # 兜底备选字体，字体文件缺失时启用
    matplotlib.rcParams["font.sans-serif"] = ["PingFang SC", "Arial Unicode MS", "Microsoft YaHei", "SimHei"]
