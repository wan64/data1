...
5.【重要修复】Matplotlib中文问号问题，全局切换 Noto Sans SC 开源中文字体
6.【关键重大修复】移除本地ttf字体依赖！Plotly云端中文□□乱码彻底解决，使用通用开源Noto Sans SC字体
...
# ==========【字体方案：弃用本地ttf，使用系统通用中文字体，适配Streamlit Cloud Linux环境】==========
# Plotly全局模板 + 全局强制Plotly字体
pio.templates.default = "plotly_white"
# 设置plotly全局默认字体，所有新建Figure自动继承
pio.templates["plotly_white"].layout.font.family = "Noto Sans SC, PingFang SC, Microsoft YaHei, sans-serif"

sns.set_style("whitegrid")

# ========== 【核心修复：Matplotlib中文字体配置 - Noto Sans SC 通用开源中文字体】 ==========
